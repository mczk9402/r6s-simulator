...
const Home: NextPage<Props> = ({ data }) => {
  ...
  useEffect(() => {
    data.map((item) => {
      setCategory((prev) => ({
        ...prev,
        operators: [...prev.operators, item.name],
      }));

      item.mainWeapons.map((mainWeapon) =>
        setCategory((prev) => ({
          ...prev,
          mainWeapons: [...prev.mainWeapons, mainWeapon.name],
        }))
      );
      ...
      item.subWeapons.map((subWeapon) =>
        setCategory((prev) => ({
          ...prev,
          subWeapons: [...prev.subWeapons, subWeapon.name],
        }))
      );

      setCategory((prev) => ({
        ...prev,
        gadgets: [...prev.gadgets, ...item.gadgets.attackerGadget, ...item.gadgets.defenderGadget],
      }));
    });
  }, []);
